...
export const CreditCardVisual = ({ 
  ...
  return (
    <div className="relative">
      ...
      {/* Cartão Verso (mini preview) */}
      <div className="w-80 h-12 bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg mt-2 p-2 flex items-center justify-between text-white text-xs">
        <div className="bg-slate-900 h-6 w-48 rounded"></div>
        <div className="font-mono text-sm">{cvv || '•••'}</div>
      </div>
    </div>
  );
};